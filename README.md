...
Copied from [Mozilla Rust Emacs](https://github.com/mozilla/rust/tree/master/src/etc/emacs)
 to make it easier to incorporate into Emacs without depending on where the code is checked out.